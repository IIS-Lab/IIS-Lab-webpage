...
export const researchIntro = {
  en: `We are looking for highly-motivated, energetic researchers and students who want to work with us. If you are interested in the following topics or just want to visit us, please feel free to ping Koji at [his_first_name] "at" iis-lab.org. If you are considering to work with us, please check [this page](/join).`,
  ja: `進学や研究室配属を決める前であっても，IIS Labに興味のある人はラボの活動や雰囲気を見に是非遊びに来てください．以下のトピックに興味のある方やラボにお越しになりたい方は，遠慮なく矢谷までメールにてご連絡ください．(メールアドレスは[矢谷の下の名前] "at" iis-lab.org)． IIS Labでの研究を志望する方は詳細は[こちらのページ](/join)をご覧ください．`,
}
